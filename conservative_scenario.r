...
#Conservative scenario (properties that has predominance lulc PST and Mosaic of Uses) + R_mean ≥ P87
# Number of properties = 2,383

library(terra)

#Ler dados de entrada
uso <- rast("E:/DOUTORADO/BEPE/Bases_geograficas/es_sp_landuse_col9_30m_MAPBIOMAS_2023_A_UGRHI2buff1500.tif")
#pol <- vect("E:/DOUTORADO/BEPE/Bases_geograficas/CUBO_b_prioridade_rest_mean_uso23_15e21_Q3_4374.shp")
pol <- vect("E:/DOUTORADO/BEPE/Bases_geograficas/CONSERVATIVE/data_graph/CUBO_b_prioridade_rest_mean_uso23_15e21_Q3_2383.shp")
...
# ETAPA 1 : Criar cenário "conservative"
...
writeRaster(cenario_clip,
            "E:/DOUTORADO/BEPE/Bases_geograficas/CONSERVATIVE/data_graph/conservative_scenario_2383.tif",
            overwrite = TRUE,
            datatype = "INT1U")
...
cenario_clip <- rast("E:/DOUTORADO/BEPE/Bases_geograficas/CONSERVATIVE/data_graph/conservative_scenario_2383.tif")
